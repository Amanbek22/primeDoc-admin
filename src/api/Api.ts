...
const http = axios.create({
    baseURL: "https://primedocapp.one:8443/api/v1/"
});
...
export default {
    ...
    docsUpload: (data: any, type:string) => http.post(`docs/upload/${type}`, data, config()),
    deleteDoc: (type:string) => http.delete(`docs/${type}`, config()),
